...
public class Account implements Serializable {
	...
	public boolean equals(final Object other) {
		...
		return new EqualsBuilder().append(name, castOther.name)
				.append(number, castOther.number).append(type, castOther.type)
				.append(balance, castOther.balance)
				.append(interestRate, castOther.interestRate)
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder(-806458195, -1310850617).append(name)
				.append(number).append(type).append(balance)
				.append(interestRate).append(currency).append(startDate)
	...
	public String toString() {
		return new ToStringBuilder(this).append("name", name)
				...
				.append("currency", currency).append("startDate", startDate)
