...
public abstract class HelloPOA extends org.omg.PortableServer.Servant
 implements corba.helloApp.HelloOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // corba/helloApp/Hello/sayHello
       {
         String $result = null;
       ...
       case 1:  // corba/helloApp/Hello/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
  ...
  public String[] _all_interfaces (org.omg.PortableServer.POA poa, byte[] objectId)//Servant¿‡÷–µƒ
  {
