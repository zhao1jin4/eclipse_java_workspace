    ...
    public static void main(String[] args) {
        try {
            ...
            Subject delegationSubject = new Subject(true, // readOnly
						                            Collections.singleton(new JMXPrincipal("delegate")),//principals
            ...
            //
            System.out.println("\nDomains:");
            String domains[] = mbsc.getDomains();//如果这里错误,修改java.policy文件
            for (int i = 0; i < domains.length; i++) {
                System.out.println("\tDomain[" + i + "] = " + domains[i]);//显示一个JMImplementation
            }
            ...
            System.out.println("\nCreate SimpleStandard MBean...");
            mbsc.createMBean("jmx_examples.security_subject.SimpleStandard", mbeanName, null, null);//修改正确类名
            //这里报错,Access denied!????
