...
public class Server {
    ...
    public static void main(String[] args) {
        try {
            ...
            String root="D:/program/eclipse_java_workspace/J_JavaSE/src/jmx_examples/security_subject";
            ...
            System.setProperty ("java.security.policy", root+"/java.policy");//Ïàµ±ÓÚ java -Dx=y
