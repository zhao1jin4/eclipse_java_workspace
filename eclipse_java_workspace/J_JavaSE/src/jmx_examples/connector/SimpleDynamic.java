...
{
	//DynamicMBean有getAttribute,setAttribute,getAttributes ,setAttributes,invoke,getMBeanInfo方法被实现
    /*
     * -----------------------------------------------------
     * CONSTRUCTORS
     * -----------------------------------------------------
     ...
     */
    public MBeanInfo getMBeanInfo()//在createMBean()方法调用 和mbs.getMBeanInfo()方法调用,会调用此方法  
    {
    ...
    private void buildDynamicMBeanInfo() {
        ...
        dOperations[0] =
            new MBeanOperationInfo("reset",
                                   "reset State and NbChanges  attributes to their initial values",
                                   params , 
                                   "void", //方法返回类型
                                   MBeanOperationInfo.ACTION);//INFO, ACTION, ACTION_INFO, UNKNOWN其中一个
        ...
        dMBeanInfo = new MBeanInfo(dClassName,
                                   ...
                                   dConstructors,
                                   dOperations,
                                   dNotifications);//MBeanInfo构造时传了很其它的MBean*Info
    }
