...
public class MemcachedClusterTest
{
	...
	public static void setUpBeforeClass() throws Exception
	{
		...
		manager.setConfigFile("memcache_client/alisoft/memcached_cluster.xml");
		manager.start();
	}
	...
	public void testClusterCopy()
	{
		try
		{
			...
			IMemcachedCache cache1 = manager.getCache("mclient1");
			IMemcachedCache cache2 = manager.getCache("mclient2");
			IMemcachedCache cache3 = manager.getCache("mclient3");
			IMemcachedCache cache4 = manager.getCache("mclient4");
			cache.clear();
			cache1.clear();
			cache2.clear();
	...
	public  void testReload()
	{
		try
		{
			...
			manager.reload("memcache_client/memcached_cluster2.xml");
