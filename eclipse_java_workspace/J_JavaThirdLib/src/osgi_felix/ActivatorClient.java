            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    DictionaryService dictionary =
                        (DictionaryService) context.getService(refs[0]);//客户端在使用时服务服务突然unregister会有问题,不好测试,refs
                    if (dictionary == null)
                    {
                        System.out.println("---I add----No dictionary available.");
                    ...
                    context.ungetService(refs[0]);//取消服务
                }
