 ...
 * the bundle.
**/
public class ActivatorClientTracker implements BundleActivator
{
    // Bundle's context.
    ...
    public void start(BundleContext context) throws Exception
    {
        ...
        try
        {
            ...
            while (true)
            {
              ...
              //客户端在使用时服务服务突然unregister会自动得到服务,不好测试
