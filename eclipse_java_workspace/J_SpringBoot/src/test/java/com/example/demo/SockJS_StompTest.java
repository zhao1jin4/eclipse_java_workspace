...
//        this.stompClient =  new WebSocketStompClient(new StandardWebSocketClient());//如不使用sockjs
        
        this.stompClient.setMessageConverter(new MappingJackson2MessageConverter());//new StringMessageConverter()
    }
