...
public class TaskTest {
	...
	public void deploymentProcessDefinition_inputStream(){
		...
		//创建角色.
		GroupEntity group1=new GroupEntityImpl();
		group1.setName("总经理");
		identityService.saveGroup(group1);
		
		GroupEntity group2=new GroupEntityImpl();
		group2.setName("部门经理");
		identityService.saveGroup(group2);
		
		
		//创建用户
		UserEntity zhang=new UserEntityImpl();
		zhang.setFirstName("张三");
		identityService.saveUser(zhang);
		
		UserEntity lisi=new UserEntityImpl();
		lisi.setFirstName("李四");
		identityService.saveUser(lisi);
		
		UserEntity wang=new UserEntityImpl();
		zhang.setFirstName("王五");
		identityService.saveUser(wang);
		//建立用户和角色的关联关系
