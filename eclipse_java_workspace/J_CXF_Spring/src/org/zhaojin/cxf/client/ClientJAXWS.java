...
{															 
    private static final QName SERVICE_NAME = new QName("http://cxf.zhaojin.org————/",  "HelloSer————");  
    private static final QName PORT_NAME    = new QName("http://cxf.zhaojin.org/", "HelloWorldPort");
