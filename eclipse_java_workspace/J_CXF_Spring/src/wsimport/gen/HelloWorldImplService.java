 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://server.hw.demo/", wsdlLocation = "http://localhost:9000/helloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://server.hw.demo/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://server.hw.demo/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.hw.demo/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
